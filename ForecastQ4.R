library(RCurl)
# Read data series from Github - Qty sold by months over 15 years and in millions
...
# Option 1 - Use library to find the best standard distribution
...
plot(option1)
summary(option1)
# Boostrapping allow to collect skew and kurtosis
descdist(as.numeric(tseries_df$x), discrete=FALSE, boot=10000)
